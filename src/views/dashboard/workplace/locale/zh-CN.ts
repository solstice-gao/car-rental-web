export default {
  ...
  'workplace.categoriesPercent': '提交状态占比',
  'workplace.pecs': '个',


  'qsk.month.commit':'当月提交数',
  'qsk.everyDay.commit':'每日提交数据',
  'qsk.everyDay.commit.success':'提交成功',
  'qsk.everyDay.commit.fails':'提交失败',
};
