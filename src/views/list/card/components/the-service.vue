...
import { queryTheServiceList, ResGroupByCompany, ServiceRecord } from '@/api/list';
...
export default defineComponent({
  ...
  setup() {
    const defaultValue: ResGroupByCompany[] = new Array();
    const { loading, response: renderData } = useRequest<ResGroupByCompany[]>(
      queryTheServiceList,
      defaultValue
    );
